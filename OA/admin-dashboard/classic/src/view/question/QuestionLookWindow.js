    ...
    items : [ 
    {
		...
		listeners:{
			beforerender:function(){
				var realAnswer=this.getForm().findField("realanswer").getValue();
				...
				if(this.getForm().findField("type").getValue()==1){//多选
					...
					var items= Ext.create("Ext.form.CheckboxGroup",{disabled:true,margin:'0 0 20 0',cls: 'x-check-group-alt',columns: 1});
