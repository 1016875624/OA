            ...
            columns: [
                ...
                {xtype: 'gridcolumn',width: 75,dataIndex: 'picture',text: '用户',
                    renderer: function(value) {
                    	if(!value){
                    		return "<img src='http://localhost:8080/images/employee/tips.jpg' height='20px' width='20px'>";
                    	}
                    	return "<img src='http://localhost:8080/images/employee/" + value + "'  height='20px' width='20px'>";
                    }
                },
